...
const styles = {
  contained: StyleSheet.create({
    button: { padding: 14, borderRadius: 50, backgroundColor: "black" },
  ...
  outlined: StyleSheet.create({
    ...
    text: { textAlign: "center", color: "black", fontSize: 18 },
  }),
  ghost: StyleSheet.create({
    button: { padding: 14, borderRadius: 50, backgroundColor: "transparent" },
    text: { textAlign: "center", color: "black", fontSize: 18 },
  }),
};
